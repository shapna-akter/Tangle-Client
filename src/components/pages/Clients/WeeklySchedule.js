...
const WeeklySchedule = () => {
  ...
  //   refetch,
  // } = useQuery({
  //   queryKey: ["schedules", id, startDate],
  //   queryFn: async () => {
  //     const url = `https://server.tanglecare.us/api/v1/schedule/caregiver-schedule?caregiverId=${id}&time=start=${formattedStartDate}&scheduleType=weekly&page=1&limit=10&skipLimit=Yes`;
